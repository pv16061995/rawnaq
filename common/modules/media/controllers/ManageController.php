...
use common\modules\media\assets\MediaAsset;
...
{
    public $modelClass = 'common\modules\media\models\Media';
    ...
    {
        $this->layout = '@common/modules/media/views/layouts/main';
