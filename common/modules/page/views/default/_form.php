                ...
                <div class="panel-body">
                    ...
                    <div class="record-info">
                        ...
                        <?= $form->field($model, 'banner')->widget(yeesoft\media\widgets\FileInput::className(), [
                                ...
                                'template' => '<div class="page-banner thumbnail"></div><div class="input-group">{input}<span class="input-group-btn">{button}</span></div>',
                                'thumb' => 'original',
                                'imageContainer' => '.page-banner',
...
$js = <<<JS
    ...
    var banner = $("#page-banner").val();
    if(banner.length == 0){
        $('.page-banner').hide();
    } else {
        $('.page-banner').html('<img src="' + banner + '" />');
    }
JS;
