...
/* @var $searchModel common\modules\testimonial\models\search\TestimonialSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('yee/testimonial', 'Testimonials');
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <?= GridPageSize::widget(['pjaxId' => 'testimonial-grid-pjax']) ?>
                </div>
            </div>

            <?php
            Pjax::begin([
                'id' => 'testimonial-grid-pjax',
            ])
            ?>
            ...
            GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'controller' => '/testimonial/default',
                        'title' => function (Testimonial $model) {
                            return Html::a($model->client_name, ['view', 'id' => $model->id], ['data-pjax' => 0]);
                        },
                    ],
                    [
                    ...
                    [
                        ...
                        'attribute' => 'status',
                        'optionsArray' => Testimonial::getStatusOptionsList(),
