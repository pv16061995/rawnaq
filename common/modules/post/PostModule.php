...
class PostModule extends \yii\base\Module
{
     ...
     * @var string
     */
    public $postModelClass = 'common\modules\post\models\Post';
     ...
     * @var string
     */
    public $postModelSearchClass = 'common\modules\post\models\search\PostSearch';
     ...
     * @var string
     */
    public $tagModelClass = 'common\modules\post\models\Tag';
     ...
     * @var string
     */
    public $tagModelSearchClass = 'common\modules\post\models\search\TagSearch';
     ...
     * @var string
     */
    public $categoryModelClass = 'common\modules\post\models\Category';
     ...
     * @var string
     */
    public $categoryModelSearchClass = 'common\modules\post\models\search\CategorySearch';
